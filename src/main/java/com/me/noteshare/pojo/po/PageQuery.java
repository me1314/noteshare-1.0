...
/**
 * Created by Sunny on 2017/3/5.
 */
public class PageQuery {

	public static final int PageQuery_pageSize_common = 5;
	...
	public void setPageParams(int infoCount, int currPage) {
		this.PageQuery_infoCount = infoCount;
		this.PageQuery_currPage = currPage;
	...
	public void setPageParams( int currPage) {
		this.PageQuery_currPage = currPage;

		float Psize_l = PageQuery_infoCount / (float) (this.PageQuery_pageSize);
		if (PageQuery_currPage < 2) {
			PageQuery_currPage = 1;
			PageQuery_start = 0;
		} else if (PageQuery_currPage > Psize_l) {
